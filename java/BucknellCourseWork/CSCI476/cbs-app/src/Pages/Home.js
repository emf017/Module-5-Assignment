...
const Home = () => {
  const { collapseSidebar } = useProSidebar(); // Define the collapseSidebar function
      ...
      <Sidebar className="app">
        <Menu>
          ...
          <SubMenu label="Reports" icon={<SummarizeIcon />}>
            <MenuItem icon={<FilePresentIcon />} className="custom-menu-item">
